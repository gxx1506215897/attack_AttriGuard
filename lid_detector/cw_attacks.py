...
class CarliniL2:
    def __init__(self, sess, model, num_channels, num_labels, batch_size=100,
        ...
        self.l2dist = tf.reduce_sum(tf.square(self.newimg - tf.tanh(self.timg) / 2), 1)
