...
train_app_filepath="./att_data/train_user.txt"
train_label_filepath="./att_data/train_label.txt"
test_app_filepath="./att_data/test_user.txt"
test_label_filepath="./att_data/test_label.txt"
